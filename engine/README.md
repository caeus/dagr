...
The name compresses **DAG runner** into `dagr`, because I'm obsessed with DAGs. It also nods to
Daguerre and the daguerreotype: `dagr` executes those DAGs by producing and composing container
images.
