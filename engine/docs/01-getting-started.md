...
This scans source directories recursively, then prints the discovered target graph in topological
order. It skips `.git` and `node_modules` and does not materialize mounts. Use it to confirm your
